...
async function main() {
  //    const stuff = await apiService.createApiManagerInstance('emp-xapi','1.0.0',
  // 'c72db99c-a5a7-4c89-9d53-66512523f678');
  //    console.info(stuff);
  ...
  //    const asset = await apiService.getExchangeAssetById(authtoken,
  //    'c72db99c-a5a7-4c89-9d53-66512523f678', 'emp-xapi');
  //    console.log(asset);
  ...
  //    const contract = await apiService.createContractRequestingAccess(authtoken,
  //    apiId, versionId, appId);
